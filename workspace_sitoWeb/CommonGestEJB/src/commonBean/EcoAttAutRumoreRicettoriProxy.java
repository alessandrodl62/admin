...
@NamedQuery(name="EcoAttAutRumoreRicettoriProxy.selectByDescrizioneIdautorizza", query="SELECT autrp FROM EcoAttAutRumoreRicettoriProxy autrp WHERE autrp.descrizione = :descrizione AND autrp.idautorizza =:idautorizza")
public class EcoAttAutRumoreRicettoriProxy implements Serializable {
  
    @Id
    private Integer idricettore;
    
    //bean proxy  per la creazione del JSonArray
