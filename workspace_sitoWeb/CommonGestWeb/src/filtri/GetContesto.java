...
import ser_vlet.AppAttivitaFacImpl;
import ser_vlet.AppAttivitaFacInterface;
...
//    AppAttivitaFacInterface application = (AppAttivitaFacInterface) request.getSession().getAttribute("application");
    ...
    persistence = (PersistAttivitaFacade)request.getSession().getServletContext().getAttribute("app.persistence");
    ...
    if(persistence==null) {
      ...
      try {
        ...
        persistence = (PersistAttivitaFacade) context.lookup("commonGest/PersistAttivitaFacadeBean/local");
